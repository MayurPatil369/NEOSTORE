...
#ifndef NEOSTORE_SWIFT_H
#define NEOSTORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="neostore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8neostore11AppDelegate")
...
SWIFT_CLASS("_TtC8neostore28ForgetPasswordViewController")
...
SWIFT_CLASS("_TtC8neostore24HomeScreenViewController")
...
SWIFT_CLASS("_TtC8neostore19LoginViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified usernameTextField;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified Forgetpasswordbtn;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified Registerbtn;
- (void)viewDidLoad;
- (IBAction)Forgetpasswordbtntapped:(id _Nonnull)sender;
- (IBAction)Registerbtntapped:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC8neostore22RegisterViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified termstext;
...
- (void)viewDidLoad;
- (IBAction)femaleButtonTapped:(id _Nonnull)sender;
- (IBAction)termsButtonTapped:(id _Nonnull)sender;
- (IBAction)maleButtonTapped:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC8neostore13SceneDelegate")
...
@interface UIViewController (SWIFT_EXTENSION(neostore)) <UITextFieldDelegate>
